<form id="mailtrap-settings" method="post" action="options.php" class="p-6 space-y-4">
  ...
  <div class="flex items-center py-2">
    <label class="block text-sm font-medium text-gray-700" for="mailtrap_enabled">
      <?php echo __('Enabled', 'mailtrap-for-wp') ?>
    </label>
    <input type="checkbox" name="mailtrap_enabled" value="1" id="mailtrap_enabled" <?php echo get_option('mailtrap_enabled') === '1' ? 'checked' : '' ?> class="ml-4">
  </div>
...
<form id="mailtrap-form" class="max-w-md mx-auto">
